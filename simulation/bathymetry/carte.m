function [z , PixelWidth] = carte(sigma, H, Lx, m , n,p,h)

% =======================================================
% Mona Mahboob Kanafi (2023). Surface generator: artificial randomly rough surfaces (https://www.mathworks.com/matlabcentral/fileexchange/60817-surface-generator-artificial-randomly-rough-surfaces), MATLAB Central File Exchange. Retrieved February 3, 2023.
% ======================================================
...
% phase components.
z = p*ifft2(ifftshift((Hm)))+ones(size(ifft2(ifftshift((Hm)))))*(h-p); % generate surface
